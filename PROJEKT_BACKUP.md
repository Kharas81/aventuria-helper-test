# 🛡️ Aventuria Projekt-Backup - 4/10/2026, 7:43:22 PM
...
<head>
    ...
    <style>
        /* Kurzer Style-Fix für bessere Lesbarkeit des Pickers */
        #adventurePicker {
            width: 100%;
            max-width: 400px;
            padding: 12px;
        ...
        #adventurePicker optgroup { font-style: normal; font-weight: bold; color: #5c1e1e; }
        .selection-box { 
            background: rgba(92, 30, 30, 0.1); 
            padding: 20px; 
            border-radius: 8px; 
            margin-bottom: 25px;
            border: 1px solid #8b4513;
...
<body>
        ...
        <header>
            ...
            <div class="top-bar">
                ...
                <div class="button-group">
                    <button class="btn-outline" onclick="window.openRulebook()">📜 Regelbuch</button>
                    <button class="btn-outline" onclick="window.Archive.open()">🃏 Archiv</button>
                </div>
            </div>
            
            <div class="selection-box">
                <select id="adventurePicker">
                    <option value="">-- Wähle ein Abenteuer --</option>
                ...
                <div id="loading-status" style="font-size: 0.85em; margin-top: 8px; font-weight: bold; color: #276749;"></div>
            </div>
        </header>
    ...
    <div id="archive-modal" class="modal-backdrop">...</div>
    <div id="rule-modal" class="modal-backdrop">...</div>
